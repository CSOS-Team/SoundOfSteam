...
public class AllPartialModels {
    ...
    TRACKER_BAR_SHAFT = block("tracker_bar/shaft"),
    TRACKER_BAR_ROLLER = block("tracker_bar/roller"),
    ...
    HOHLFLUTE_MOUTH_TINY = block("hohlflute/hohlflute_tiny_mouth"),
    HOHLFLUTE_MOUTH_SMALL = block("hohlflute/hohlflute_small_mouth"),
    HOHLFLUTE_MOUTH_MEDIUM = block("hohlflute/hohlflute_medium_mouth"),
    ...
    OKTAV_MOUTH_TINY = block("oktav/oktav_tiny_mouth"),
    OKTAV_MOUTH_SMALL = block("oktav/oktav_small_mouth"),
    OKTAV_MOUTH_MEDIUM = block("oktav/oktav_medium_mouth"),
    OKTAV_MOUTH_LARGE = block("oktav/oktav_large_mouth"),
    OKTAV_MOUTH_HUGE = block("oktav/oktav_huge_mouth"),

    SUBBASS_MOUTH_TINY = block("subbass/subbass_tiny_mouth"),
    ...
    ENGLISH_HORN_MOUTH_LARGE = block("english_horn/english_horn_large_mouth"),
    ENGLISH_HORN_MOUTH_HUGE = block("english_horn/english_horn_huge_mouth"),
    ...
    TIERCE_MOUTH_TINY = block("tierce/tierce_tiny_mouth"),
    TIERCE_MOUTH_SMALL = block("tierce/tierce_small_mouth"),
    TIERCE_MOUTH_MEDIUM = block("tierce/tierce_medium_mouth"),
    TIERCE_MOUTH_LARGE = block("tierce/tierce_large_mouth"),
    TIERCE_MOUTH_HUGE = block("tierce/tierce_huge_mouth"),

    POSAUNE_MOUTH_TINY = block("posaune/posaune_tiny_mouth"),
    ...
    VOX_CELESTE_MOUTH_TINY = block("vox_celeste/vox_celeste_tiny_mouth"),
    ...
    HORIZONTAL_GOGGLES_TINY = block("goggles/horizontal/horizontal_goggles_tiny"),
    HORIZONTAL_GOGGLES_SMALL = block("goggles/horizontal/horizontal_goggles_small"),
    HORIZONTAL_GOGGLES_MEDIUM = block("goggles/horizontal/horizontal_goggles_medium"),
    HORIZONTAL_GOGGLES_LARGE = block("goggles/horizontal/horizontal_goggles_large"),
    HORIZONTAL_GOGGLES_HUGE = block("goggles/horizontal/horizontal_goggles_huge"),
