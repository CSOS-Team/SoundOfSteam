...
public class HauntedJetParticle extends SimpleAnimatedParticle {

    private float yaw, pitch;

    protected HauntedJetParticle(ClientLevel world, HauntedJetParticleData data, double x, double y, double z, double dx,
    ...
    public static class Factory implements ParticleProvider<HauntedJetParticleData> {
        ...
        public Particle createParticle(HauntedJetParticleData data, ClientLevel worldIn, double x, double y, double z,
                                       double xSpeed, double ySpeed, double zSpeed) {
            return new HauntedJetParticle(worldIn, data, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
        }
    }
