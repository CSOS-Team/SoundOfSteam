...
public class TrackerBarDisplaySources {
    ...
    public static class FilenameSource extends SingleLineDisplaySource {
        ...
        protected MutableComponent provideLine(DisplayLinkContext context, DisplayTargetStats stats) {
            ...
            return Component.literal(sequencerBehaviour.getCurrentMidi());
        }
    ...
    public static class BPMSource extends SingleLineDisplaySource {
