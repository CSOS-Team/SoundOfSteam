...
public class HauntedWhistleRenderer extends SafeBlockEntityRenderer<HauntedWhistleBlockEntity> {
    ...
    protected void renderSafe(HauntedWhistleBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource bufferSource, int light, int overlay) {
        ...
        EPipeSizes.PipeSize size = blockState.getValue(HauntedWhistleBlock.SIZE);
