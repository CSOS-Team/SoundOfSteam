...
public class DiapasonRenderer extends SafeBlockEntityRenderer<DiapasonBlockEntity> {
    ...
    protected void renderSafe(DiapasonBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource bufferSource, int light, int overlay) {
        ...
        GenericWhistleProperties.WhistleSize size = blockState.getValue(DiapasonBlock.SIZE);

        PartialModel mouth = size == GenericWhistleProperties.WhistleSize.TINY ? AllPartialModels.DIAPASON_MOUTH_TINY :
                size == GenericWhistleProperties.WhistleSize.SMALL ? AllPartialModels.DIAPASON_MOUTH_SMALL :
                size == GenericWhistleProperties.WhistleSize.MEDIUM ? AllPartialModels.DIAPASON_MOUTH_MEDIUM :
                        size == GenericWhistleProperties.WhistleSize.LARGE ? AllPartialModels.DIAPASON_MOUTH_LARGE : AllPartialModels.DIAPASON_MOUTH_HUGE;
