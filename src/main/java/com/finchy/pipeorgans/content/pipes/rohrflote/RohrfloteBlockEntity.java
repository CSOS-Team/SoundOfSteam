...
public class RohrfloteBlockEntity extends GenericPipeBlockEntity {
    public RohrfloteBlockEntity(BlockPos pos, BlockState blockState) {
        super(pos, blockState, AllBlockEntities.ROHRFLOTE_BLOCK_ENTITY);
    }
